from math import e # import e agar nilainya terdeteksi program

# Fungsi menjalankan integrasi metode trapesium
...
# Input batas bawah, batas atas, dan jumlah partisi (n)
