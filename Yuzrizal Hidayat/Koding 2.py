import math # library math digunakan untuk "e" bisa terdeteksi sebagai nilai
import numpy as np # library numpy digunakan untuk fungsi yang berkaitan dengan perhitungan
import matplotlib.pyplot as plt # library matplotlib.pyplot digunakan untuk membuat dan menampilkan grafik

# fungsi untuk mencari akar
def f(x):
    return eval(persamaan)

# fungsi untuk mencari akar menggunakan metode bagi dua 
...
# Input persamaan, interval, jumlah maksimum iterasi, dan ketelitian
persamaan = input("Masukkan persamaan fungsi (contoh: 'x**2 - 2*x - 8'): ")

# Ganti "e" dengan math.e dalam persamaan agar terdeteksi
